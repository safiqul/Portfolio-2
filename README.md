...
2. Write test cases to show that your solutions can handle losses, reordering and duplicates. Test with all three reliable functions and report your results.
